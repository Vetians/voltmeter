...
// Database schema
$schema = "
CREATE DATABASE IF NOT EXISTS voltmeter_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE voltmeter_db;
...
('USR001', 'admin', '" . password_hash('admin123', PASSWORD_DEFAULT) . "', 'Administrator', 'admin'),
('USR002', 'surveyor1', '" . password_hash('admin123', PASSWORD_DEFAULT) . "', 'Budi Santoso', 'surveyor'),
('USR003', 'surveyor2', '" . password_hash('admin123', PASSWORD_DEFAULT) . "', 'Siti Rahayu', 'surveyor');
...
echo json_encode([
    'message' => 'Copy SQL schema ke phpMyAdmin',
    'schema' => $schema,
    'default_users' => [
        ['username' => 'admin', 'password' => 'admin123', 'role' => 'admin'],
        ['username' => 'surveyor1', 'password' => 'admin123', 'role' => 'surveyor'],
        ['username' => 'surveyor2', 'password' => 'admin123', 'role' => 'surveyor']
    ]
]);
